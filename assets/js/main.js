...
function initPasswordToggle() {
  ...
  if (passwordToggleBtn && passwordInput && eyeIcon) {
    passwordToggleBtn.addEventListener("click", (e) => {
      ...
      // Toggle icon - use eye and eye-slash for better compatibility
      if (isPasswordVisible) {
        // Password was visible, now hiding it
        eyeIcon.classList.remove("uil-eye-slash");
        eyeIcon.classList.add("uil-eye");
      } else {
        // Password was hidden, now showing it
...
// Initialize password toggle on DOM content loaded
...
class ClassButtonsManager {
  ...
  attachButtonHandlers() {
    ...
    console.log("Found .class-btn buttons:", buttons.length);
  ...
  attachCardHandlers() {
    ...
    console.log("Found .class-card elements:", cards.length);
